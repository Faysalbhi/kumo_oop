...
if($flag){
  ...
  header("location: all_user.php#exampleModalCenter");
}else{
      ...
      $sql=$conn->prepare("UPDATE users SET fname=:fname,lname=:lname,uname=:uname,email=:email,user_role=:user_role,password=:password WHERE id=:id");
       $sql->execute();
